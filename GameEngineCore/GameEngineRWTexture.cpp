...
GameEngineRWTexture* GameEngineRWTexture::Create(const std::string& _name)
{
    return CreateNamedRes(_name);
}

GameEngineRWTexture* GameEngineRWTexture::Create()
{
...
void GameEngineRWTexture::CreateUnorderedAccessTexture(GameEngineTexture* _texture, const float4& _clearColor)
{
