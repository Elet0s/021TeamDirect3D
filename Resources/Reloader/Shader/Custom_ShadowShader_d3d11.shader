...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  LOD 200
  Tags { "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
  ZWrite Off
  Cull Off
  GpuProgramID 111054
Program "vp" {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "Meta"
  LOD 200
  Tags { "LIGHTMODE" = "META" "QUEUE" = "Geometry" "RenderType" = "TransparentCutout" }
  Cull Off
  GpuProgramID 409385
Program "vp" {
SubProgram "d3d11 " {
