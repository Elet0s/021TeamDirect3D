...
public:
	...
	{
		return *this->playerPassiveInfo_;
	}
	...
	SkillManager* GetSkillManager()
	{
		...
		{
			return this->playerSkillManager_;
		}
	}

	CollisionReturn PlayerToGameItemObjectCollision(GameEngineCollision* _This, GameEngineCollision* _Other);
	CollisionReturn ItemRangeToGameItemObjectCollision(GameEngineCollision* _This, GameEngineCollision* _Other);
...
public:
	...
	GameEngineCollision* itemRangeCollision_;
